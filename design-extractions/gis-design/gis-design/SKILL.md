---
name: gis-design
description: Design system skill for gis. Activate when building UI components, pages, or any visual elements. Provides exact color tokens, typography scale, spacing grid, component patterns, and craft rules. Read references/DESIGN.md before writing any CSS or JSX.
---

# gis Design System

You are building UI for **gis**. Light-themed, neutral palette, sans-serif typography (sans-serif), compact density on a 4px grid, flat elevation (no shadows).
...
![gis Homepage](screenshots/homepage.png)
...
- **Site URL:** `https://gis.com.bo/](https://gis.com.bo/`
...
- Creating new components, pages, or visual elements for gis
- Writing CSS, Tailwind classes, styled-components, or inline styles
- Building page layouts, templates, or responsive designs
- Reviewing UI code for design consistency
- The user mentions "gis" design, style, UI, or theme
