 ...
 *  - Los libros contables en /public/data/excel. CADIS_Control_Ingresos_Egresos...xlsx
 *    registra ventas y reservas por nombre y monto en Bs. sin teléfono ni lote
 *    formal, por lo que esos campos quedan marcados como pendientes en los leads
 *    con origen "registro_contable_excel".
 *
 * Nota: Planilla_CADIS_MINI_QUINTAS_RIO_BONITO.xlsx (hojas "Registro de
 * Comisiones" y "Resumen Mensual") fue revisado y solo contiene pagos de
 * comisión a un asesor (Carlos Arteaga), sin nombre de cliente comprador,
 * lote asignado, precio ni saldo pendiente. No aporta leads y no se usó para
